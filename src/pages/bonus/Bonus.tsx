...
const BonusList = () => {
  const { data, isLoading } = useGetAllBonusQuery({});
  ...
  const handleCreate = () => {
    setSelectedBonus(undefined); // no bonus = create new
    setIsModalOpen(true);
  };
      ...
      <Box className="mb-4">
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            disabled={!!bonus} // disable if bonus already exists
          >
            Yangi bonus
          </Button>
        </div>
